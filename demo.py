...
def main():
    ...
    parser.add_argument('-f', '--folder_path', help='Path to video folder', required=False, default=os.path.join(HOME, "GIT/Spoofing-ICASSP19/datasets/SiW-dataset"), type=str)
    ...
    parser.add_argument('-te', '--testing_file', help='Path to testing txt file', required=False, default=os.path.join(HOME, "GIT/Spoofing-ICASSP19/datasets/SiW-dataset/directions-2-test.txt"), type=str)
    parser.add_argument('-tr', '--training_file', help='Path to training txt file', required=False, default=os.path.join(HOME, "GIT/Spoofing-ICASSP19/datasets/SiW-dataset/directions-2-train.txt"), type=str)
